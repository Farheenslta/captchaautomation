...
public class OcrSiteViaSelenium4
{
	public static void main(String[] args) throws Exception
	{
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("tbName"))).sendKeys("farsul");
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("tbMobile"))).sendKeys("9177784264");
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("tbEmail"))).sendKeys("farsult@gmail.com");
		...
		t.setDatapath("F:\\Automation_PracticePrograms\\captchaautomation\\tessdata");
